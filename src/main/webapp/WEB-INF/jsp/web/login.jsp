...
<link rel="stylesheet" type="text/css" href="/res/css/zzsc.css">
<style type="text/css">
	.form-bg{
		padding: 2em 0;
	}
				...
				<form class="form-horizontal" action="/web/login.do" method="post">
					...
					<div class="form-group">
					  <div class="main-checkbox">
						<input type="checkbox" value="login" id="checkbox1" name="isRem"/>
							<label for="checkbox1"></label>
						</div>
						<span class="text">记住我</span>
					  <button type="submit" id="btnLogin" class="btn btn-default">立刻登录</button>
					</div>
				</form>
			</div>
		</div>
