				...
				<div class="container-fluid">
					<div class="">
						<ul class="tabBtn clearfix" style="width: 50%; margin: auto;">
							<li class="on">可添加到试卷的题目列表</li>

						</ul>
						<ul class="tabBox panel mt10">
							<li class="on">
								<div class="pd10 grayBg2">
									<a href="/web/paper/qst"><button type="button" class="btn btn-primary r doctorAddBtn">添加试题</button></a>
								</div>
								<div class="pd10">
									<table class="table drugsTable ftc" id="userList">
										...
										<tbody>
											<tr>
												<td><input type="checkbox" name="qst"></td>
												<td>试题1</td>
												<td>10</td>
												<td>一般</td>
												<td>继承</td>
