...
<html lang="en">
	...
	<body>
		...
		<div class="bombBox" id="addDoctorBomb" >
			<div class="bombContent whiteBg addDoctorBomb" style="min-width: 500px;margin-top: -350px;">
				<div class="bombTit">新增试卷
					<a class="fa fa-remove" href="/web/paper" target="main"></a>
				</div>
				<div class="pd20">
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">类型：</span></span>
						<input class="form-control" type="text" value="" id="true_name" width="200px">
					</div>
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">单选题个数：</span></span>
						<input class="form-control" type="number" value="" min="0" max="20" width="300px">
					</div>
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">单选题总分数：</span></span>
						<input class="form-control" type="number" value="" min="0" max="50" >
					</div>
					<div class="input-group listSeaForm mt10 wb100">
					...
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">多选题总分数：</span></span>
						<input class="form-control" type="number" value="" min="0" max="50" >
					</div>
					<div class="input-group listSeaForm mt10 wb100">
					...
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">判断题总分数：</span></span>
						<input class="form-control" type="number" value="" min="0" max="50" >
					</div>
					<div class="input-group listSeaForm mt10 wb100">
					...
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">主观题总分数：</span></span>
						<input class="form-control" type="number" value="" min="0" max="50" >
					</div>
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">开始时间：</span></span>
						<input class="form-control" type="datetime-local" value="" min="0" max="50" >
					</div>
					<div class="input-group listSeaForm mt10 wb100">
						<span class="input-group-btn"><span class="btn">考试时长：</span></span>
						<input class="form-control" type="number" id="a-age" min="10" max="180" value="">
					</div>
				</div>
				<div class="pd20">
